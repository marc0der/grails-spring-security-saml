...
<html>
	...
	<body>
		<div style="margin-left: 20px;">
			...
			<h1>Login/Logout</h1>
			<sec:ifLoggedIn>Welcome back, <sec:loggedInUserInfo field="fullName"/> | <sec:logoutLink local="true">Local logout</sec:logoutLink> | <sec:logoutLink>Global logout</sec:logoutLink> </sec:ifLoggedIn>
			<sec:ifNotLoggedIn>
